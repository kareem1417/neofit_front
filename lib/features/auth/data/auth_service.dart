...
class AuthService {
  ...
  Future<Map<String, dynamic>> login(String email, String password) async {
    try {
      ...
      final errorMessage = e.response?.data['message'] ?? e.response?.data['error'] ?? 'Failed to register';
  ...
  try {
    ...
    final serverMessage = e.response?.data?['message'] ?? e.response?.data?['error'] ?? 'Failed to register';
